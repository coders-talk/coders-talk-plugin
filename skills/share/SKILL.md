---
name: share
description: Same as /coders-talk:build. Send this Claude Code session to Coders Talk as a draft Build that the user reviews and publishes on the site. Runs only when the user types /coders-talk:share.
